...
func _physics_process(delta):
	...
	#This variable is used for the walljumptimer to help fix the wall jumps inaccuracies
	...
	#This checks so the player can't wall jump when thye're on the ground
